...
class ARService {
  ...
  Future<void> init({
    ...
    // 🔥 registrar callbacks para aplicar los gestos al nodo
    _setupNativeGestures();
  }

  /// Activa callbacks nativos de PAN y ROTATION y aplica la transformación resultante
